...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`${collapsed ? 'w-16' : 'w-60'} transition-all duration-200 bg-white border-r border-gray-100 flex flex-col min-h-screen shrink-0`}
    >
      {/* Logo */}
      <div className="flex items-center gap-3 px-4 py-5 border-b border-gray-100">
        ...
        {!collapsed && (
          <div>
            <p className="font-display font-bold text-gray-900 text-sm leading-tight">PIC</p>
            <p className="text-xs text-gray-400 leading-tight">Ideias Criativas</p>
          </div>
        )}
        <button
      ...
      {/* User */}
      <div className={`px-3 pb-4 border-t border-gray-100 pt-3 ${collapsed ? 'flex justify-center' : ''}`}>
        {!collapsed ? (
